      ...
      questions: [
        {
          ...
          id: 'indirect_competitors',
          question: 'Напиши основных КОСВЕННЫХ конкурентов (компании близкие к твоему рынку, но главный бизнес-процесс основан на других продуктах, потенциально ЦА может получить выгоду или решение хотя бы частично через них)',
          answerType: ActionType.objectArray,
          payload: {
            title: 'Косвенные конкуренты',
            description: 'Косвенные (Компании близкие к твоему рынку, но главный бизнес-процесс основан на других продуктах, потенциально ЦА может получить выгоду или решение хотя бы частично через них). Также отметь свойства, которые есть у конкурентов.',
            itemName: 'Конкурент',
            btnText: 'Прописать прямых',
            minElements: 2,
          ...
          id: 'alternative_competitors',
          question: 'Напиши основных АЛЬТЕРНАТИВНЫХ конкурентов (компании вообще не из твоего рынка)',
          answerType: ActionType.objectArray,
          payload: {
            title: 'Альтернативные конкуренты',
            description: 'Альтернативы (компании вообще не из твоего рынка).. Также отметь свойства, которые есть у конкурентов.',
            itemName: 'Конкурент',
            btnText: 'Прописать прямых',
            minElements: 1,
